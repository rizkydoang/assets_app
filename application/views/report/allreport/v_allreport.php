		...
		<div class="col-xs-12">
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#all" data-toggle="tab">All Report</a></li>
				</ul>
				<div class="tab-content">
					<!-- Tab Inventory -->
					<div class="tab-pane fade in active" id="all">
						<form action="<?= base_url('All_report/allReportExportExcel') ?>" method="POST">
							<section id="new">
								<div class="box-header">
									...
									<button type="button" class="btn btn-primary" id="btn_all_cari">Cari</button>

								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<table id="table-all-report" class="table table-bordered table-striped" style="width:100%">
										<thead>
											<tr>
												<th>No.</th>
												<th>Asset Code</th>
