...
class All_report extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('overview', 'report/allreport/v_allreport', $data);
	}
	...
	public function getAllReport()
	{
		...
		$list = $this->m_allreport->all_report($dateFrom, $dateTo, $division);
		$data = array();
		$no = 1;
	...
	public function allReportExportExcel()
	{
		...
		$filename = 'All_Report.xlsx'; //save our workbook as this file name
